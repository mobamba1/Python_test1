...
def three(arg1):
	if arg1 % 3 == 0 and arg1 % 5 == 0 and arg1 != 0:
		return "fizzbuzz"
	elif arg1 % 3 == 0 and arg1!= 0:
		return "fizz"
	elif arg1 % 5 == 0 and arg1 !=0:
		return "buzz"
	else:
		return "null"
...
def six(input):
	for i in range(len(input)-1):
		if input[i-1] != "c" and input[i] == "i" and input[i+1] == "e":
			return True
		elif input[i-1] == "c" and input[i] == "e" and input[i+1] == "i":
			return True
	else:
		return False
